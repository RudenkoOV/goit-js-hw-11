...
export default async function findImage(key, text, imageType, orientation, safesearch, pageNumber) {
        ...
        const response = await fetch(`https://pixabay.com/api/?key=${key}&q=${text}&image_type=${imageType}&orientation=${orientation}&safesearch=${safesearch}&page=${pageNumber}&per_page=40`);
